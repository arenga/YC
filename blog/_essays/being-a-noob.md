...
어렸을 때 저는 나이 든 사람들이 모든 것을 다 알고 있다고 생각했습니다. 이제 저는 나이가 들었고, 이것이 사실이 아니라는 것을 압니다.

저는 끊임없이 초보자처럼 느껴집니다. 항상 제가 모르는 새로운 분야에서 일하는 스타트업과 이야기를 나누는 것 같고, 제가 잘 이해하지 못하는 주제에 관한 책을 읽는 것도 있고, 어떻게 돌아가는지 모르는 새로운 나라를 방문하는 것도 있는 것 같습니다.

"noob"이라는 단어는 확실히 칭찬이 아닙니다. 하지만 오늘 저는 초보자가 되는 것에 대해 고무적인 사실을 깨달았습니다. **현지에서 초보자일수록, 전 세계적으로는 초보자가 아닙니다.**

예를 들어, 고국에 머무르면 모든 것이 다르게 작동하는 파라와비아로 이사하는 것보다 초보자 같은 느낌이 덜할 것입니다. 하지만 움직이면 더 많은 것을 알게 될 것입니다. 그래서 초보자 같은 느낌은 실제 무지와 역의 상관 관계가 있습니다.

그런데 초보자 같은 느낌이 우리에게 좋다면, 왜 우리는 그것을 싫어합니까? 그러한 혐오감은 어떤 진화적 목적에 도움이 될 수 있습니까?

초보자처럼 느껴지는 데는 두 가지 원인이 있다고 생각합니다. 바로 멍청하다는 것과 뭔가 새로운 일을 하는 것입니다. 초보자처럼 느껴지는 것을 싫어하는 것은 우리의 뇌가 "어서, 어서, 이걸 알아내세요"라고 말하는 것입니다.

인류 역사의 대부분 동안 그렇게 생각하는 것이 옳은 일이었습니다. 수렵채집인의 삶은 복잡했지만, 지금의 삶만큼 크게 변하지는 않았습니다. 그들은 암호화폐에 대해 무엇을 해야 할지 갑자기 알아낼 필요가 없었습니다.

따라서 새로운 문제의 발견보다 기존 문제에 대한 역량에 편향되는 것이 합리적이었습니다. 음식이 부족한 세상에서 배고픈 느낌을 싫어하는 것이 당연한 것처럼, 인간이 초보자 같은 느낌을 싫어하는 것이 합리적이었습니다.

이제 음식이 너무 적은 것보다 너무 많은 것이 더 문제이므로, 배고픈 느낌을 싫어하는 것이 우리를 잘못된 길로 인도합니다. 그리고 우리가 초보자 같은 느낌을 싫어하는 것도 그런 것 같습니다.

불쾌하고 때로는 사람들이 당신을 비웃기도 하지만, **초보자 같은 기분이 들수록 더 좋습니다.**
