...
최근 나는 결합하면 폭발할 두 가지 아이디어를 머릿속에 품고 있다는 것을 깨달았습니다.

첫 번째는 스타트업이 산업 혁명 규모의 새로운 경제 단계를 대표할 수 있다는 것입니다. 확실하지는 않지만 사실일 가능성이 꽤 있는 것 같습니다. 사람들은 스타트업의 창업자나 초기 직원으로서 훨씬 더 생산적입니다. 래리와 세르게이가 대기업에 입사했다면 얼마나 적은 성과를 거두었을지 상상해보세요. 그리고 그 정도의 개선이 사회적 관습을 바꿀 수도 있습니다.

두 번째 생각은 스타트업은 특정 분야에서 번성하는 사업이라는 것입니다. 로스앤젤레스가 영화를 전문으로 하거나 뉴욕이 금융을 전문으로 하는 것과 마찬가지로 실리콘 밸리도 스타트업을 전문으로 합니다.[1]

둘 다 사실이라면 어떻게 될까요? 스타트업이 새로운 경제 국면이자 특정 중심지에서만 번성하는 사업 유형이라면 어떨까요?

그렇다면 이 혁명은 특히 혁명적일 것입니다. 이전의 모든 혁명이 확산되었습니다. 농업, 도시, 산업화가 모두 널리 퍼졌습니다. 만약 스타트업이 소수의 센터와 하나의 지배적인 센터로 끝나는 영화 산업처럼 된다면, 그것은 새로운 결과를 가져올 것입니다.

스타트업이 특히 잘 확산되지 않을 수 있다는 징후가 이미 있습니다. 지금은 통신이 훨씬 빨라졌음에도 불구하고 스타트업의 확산은 산업혁명의 확산보다 더 느리게 진행되고 있는 것 같습니다.

Boulton & Watt가 창립된 지 수십 년 이내에 증기기관은 북유럽과 북미 전역에 흩어져 있었습니다. 한동안 산업화는 해당 지역을 넘어 크게 확산되지 않았습니다. 그것은 강력한 중산층이 있는 곳, 즉 민간인이 재산을 몰수하지 않고도 큰 돈을 벌 수 있는 나라에만 퍼졌습니다. 그렇지 않으면 공장에 투자할 가치가 없었습니다.

하지만 중산층이 강한 나라에서는 산업기술이 뿌리내리기 쉬웠다. 개별 광산이나 공장 소유자는 증기 기관을 설치하기로 결정할 수 있으며, 몇 년 안에 증기 기관을 만들어 줄 현지 사람을 찾을 수도 있습니다. 그래서 증기기관은 빠르게 확산되었습니다. 그리고 광산과 공장의 위치가 강, 항구, 원자재 공급원과 같은 지형에 따라 결정되었기 때문에 널리 퍼졌습니다.[2]

스타트업은 그다지 잘 확산되지 않는 것 같습니다. 부분적으로는 기술적인 현상이라기보다는 사회적이기 때문이고, 부분적으로는 지리에 얽매이지 않기 때문입니다. 개별 유럽 제조업체는 산업 기술을 수입할 수 있으며 잘 작동할 것입니다. 이는 스타트업에서는 그다지 잘 작동하지 않는 것 같습니다. 영화 사업에서와 마찬가지로 전문 지식 커뮤니티가 필요합니다.[3]

게다가 스타트업이 확산되도록 이끄는 동일한 힘도 없습니다. 철도나 전력망이 발명되면 모든 지역에 이를 보유해야 했습니다. 철도나 전력이 없는 지역은 풍부한 잠재 시장이었습니다. 하지만 스타트업에서는 그렇지 않습니다. 프랑스의 마이크로소프트나 독일의 구글은 필요 없습니다.

정부는 지역적으로 스타트업을 장려하기로 결정할 수도 있지만, 정부 정책으로는 스타트업이 진정한 필요를 충족하도록 요구할 수 없습니다.

이 모든 일이 어떻게 진행될까요? 지금 예측해야 한다면, 스타트업이 확산될 것이라고 말하고 싶지만 매우 느리게 확산될 것입니다. 왜냐하면 스타트업의 확산은 정부 정책(작동하지 않음)이나 시장 요구(존재하지 않음)에 의해 주도되는 것이 아니라, 지금까지 스타트업 문화를 확산시켰던 것과 동일한 무작위 요인에 의해 주도될 것이기 때문입니다. 그리고 이러한 임의적 요인은 기존 스타트업 허브의 매력보다 점점 더 커질 것입니다.

실리콘 밸리가 있는 곳은 William Shockley가 자신이 자란 팔로알토로 돌아가고 싶어했고, 그가 서부로 데려와 함께 일하게 한 전문가들이 그곳을 너무 좋아해서 머물렀기 때문입니다. 시애틀이 기술 센터로서의 위치를 ​​차지하는 이유는 대부분 같은 이유 때문입니다. Gates와 Allen은 집으로 이사하기를 원했습니다. 그렇지 않으면 앨버커키가 순위에서 시애틀의 자리를 차지할 수도 있습니다.

보스턴은 미국과 아마도 세계의 지적 중심지이기 때문에 기술 중심지입니다. 그리고 Battery Ventures가 페이스북이 무너지지 않았다면 보스턴은 스타트업 레이더 화면에서 훨씬 더 커질 것입니다.

그러나 물론 페이스북이 보스턴이 아닌 밸리에서 자금을 조달한 것은 우연이 아닙니다. 보스턴보다 실리콘 밸리에 더 많고 더 대담한 투자자가 있으며 심지어 학부생들도 이를 알고 있습니다.

보스턴의 사례는 게임 후반부에 새로운 스타트업 허브를 구축하는 데 어려움을 겪게 될 것임을 보여줍니다. 기존의 방식을 재현해 창업 허브를 만들고 싶다면, 부자들이 살고 싶어할 만큼 좋은 곳에 일류 연구대학을 세우는 것이 방법일 것이다. 그러면 그 도시는 창업자와 투자자 모두에게 필요한 두 그룹 모두에게 친절할 것입니다. 이것이 바로 실리콘밸리를 탄생시킨 조합이다.

하지만 실리콘 밸리에는 경쟁할 실리콘 밸리가 없었습니다. 지금 좋은 대학을 좋은 곳에 세워서 스타트업 허브를 만들려고 한다면, 그 곳에서 배출한 최고의 스타트업 중 다수가 기존 스타트업 허브로 빨려 들어갈 것이기 때문에 시작하기가 더 어려울 것입니다.

최근 저는 잠재적인 지름길을 제안했습니다. 바로 스타트업에 돈을 주고 이전하는 것입니다. 한 곳에 좋은 스타트업이 충분히 있으면 자립적인 연쇄 반응이 일어날 것입니다. 창업자들은 동료들이 있었기 때문에 돈을 받지 않고 그곳으로 이사하기 시작했고, 거래가 이루어졌기 때문에 투자자들도 나타날 것입니다.

실제로 어떤 정부도 이것을 시도할 배짱이나 제대로 할 수 있는 두뇌를 갖고 있을지 의심스럽습니다. 실용적인 제안을 의미하는 것이 아니라 스타트업 허브를 의도적으로 만드는 데 필요한 하한선에 대한 탐색에 더 가깝습니다.

가장 가능성이 높은 시나리오는 (1) 어떤 정부도 스타트업 허브를 성공적으로 구축하지 않을 것이며, (2) 스타트업 문화의 확산은 지금까지 이를 추진해 온 임의적인 요인에 의해 주도될 것이지만 (3) 이러한 요인이 기존 스타트업 허브의 매력을 점점 더 압도할 것이라는 것입니다.

결과: 이 혁명이 일어난다면 비정상적으로 국지화될 것입니다.

**참고**

[1] 스타트업에는 매우 다른 두 가지 유형이 있습니다. 하나는 자연스럽게 진화하는 유형이고, 다른 하나는 과학적 발견을 "상업화"하기 위해 탄생한 유형입니다. 대부분의 컴퓨터/소프트웨어 스타트업은 이제 첫 번째 유형이고, 대부분의 제약 스타트업은 두 번째 유형입니다. 이 에세이에서 스타트업에 대해 이야기할 때는 유형 I 스타트업을 의미합니다.

Type II 스타트업을 확산시키는 데는 어려움이 없습니다. 의학 연구실에 자금을 지원하기만 하면 됩니다. 보핀이 던지는 새로운 발견을 상업화하는 것은 새로운 공항을 건설하는 것만큼 간단합니다. Type II 스타트업은 스타트업 문화를 요구하지도 생산하지도 않습니다. 하지만 이는 유형 II 스타트업이 있다고 해서 유형 I 스타트업을 얻을 수 없다는 의미입니다. 필라델피아가 적절한 예입니다. 유형 II 스타트업은 많지만 유형 I 스타트업은 거의 없습니다.

우연히도 Google이 유형 II 스타트업의 사례로 보일 수도 있지만 그렇지 않았습니다. Google은 페이지랭크를 상용화하지 않습니다. 그들은 다른 알고리즘을 사용할 수도 있었고 모든 것이 동일하게 나타났을 것입니다. 구글을 구글로 만든 것은 웹 진화의 중요한 시점에서 검색을 잘하는 데 신경을 썼기 때문이다.

[2] 와트는 증기기관을 발명하지 않았다. 그의 중요한 발명품은 증기 기관을 훨씬 더 효율적으로 만드는 개량 기술인 분리형 응축기였습니다. 그러나 이는 그의 역할을 지나치게 단순화합니다. 그는 문제에 대해 매우 다른 태도를 가지고 있었고, 그 분야를 변화시킬 만큼 에너지로 문제에 접근했습니다. 아마도 가장 정확한 표현은 와트가 증기 기관을 재창조했다고 말하는 것일 것입니다.

[3] 여기서 가장 큰 반례는 Skype입니다. 미국에서 폐쇄될 일을 하고 있다면 다른 곳에 있는 것이 유리할 것입니다. 이것이 바로 Kazaa가 Napster를 대신한 이유입니다. 그리고 창립자들이 Kazaa를 운영하면서 얻은 전문 지식과 인맥은 Skype의 성공을 보장하는 데 도움이 되었습니다.

**감사의 말**

초안을 읽어주신 Patrick Collison, Jessica Livingston 및 Fred Wilson에게 감사드립니다.
