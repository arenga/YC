...
difficulty: 중급
year: 
url_original: "https://paulgraham.com/bias.html"
---

## 요약 (Summary)

🎯 편견을 감지하는 확실한 방법이 있을까요?
...
2015년 10월이것은 많은 사람들에게 놀라운 일이겠지만, 어떤 경우에는 지원자 풀에 대해 전혀 알지 못한 채 선발 과정에서 편견을 감지하는 것이 가능합니다.무엇보다도 제3자가 이 기술을 사용하여 선택을 수행하는 사람들이 원하는지 여부에 대한 편견을 탐지할 수 있다는 점에서 흥미롭습니다. (a) 선택된 지원자의 무작위 샘플이 있고, (b) 지원자의 후속 성과가 측정되고, (c) 비교하는 지원자 그룹의 능력 분포가 거의 동일할 때마다 이 기술을 사용할 수 있습니다. 어떻게 작동합니까?편견이 있다는 것이 무엇을 의미하는지 생각해 보세요.선택 과정이 x 유형의 지원자에 대해 편향된다는 것은 그들이 통과하기가 더 어렵다는 것을 의미합니다.이는 x 유형의 지원자가 x 유형이 아닌 지원자보다 선발되기에 더 유리해야 함을 의미합니다.[1] 이는 선발 과정을 통과한 x 유형의 지원자가 다른 성공적인 지원자보다 뛰어난 성과를 낼 것임을 의미합니다.그리고 합격한 모든 지원자들의 성취도를 측정해 보면 그들이 합격했는지 알 수 있습니다. 물론 성취도를 측정하기 위해 사용하는 테스트는 유효한 것이어야 합니다.특히 측정하려는 편견으로 인해 그것이 무효화되어서는 안 됩니다.그러나 성과를 측정할 수 있는 일부 영역이 있으며 이러한 영역에서는 편향을 탐지하는 것이 간단합니다.선발 과정이 특정 유형의 지원자에 대해 편향되어 있는지 알고 싶으십니까?그들이 다른 사람들보다 뛰어난지 확인하세요.이는 단지 편견을 탐지하기 위한 경험적 방법이 아닙니다.편견이 의미하는 바입니다. 예를 들어, 많은 사람들은 벤처 캐피털 회사가 여성 창업자에 대해 편견을 가지고 있다고 의심합니다.이는 쉽게 감지할 수 있습니다. 포트폴리오 회사 ​​중에서 여성 창업자가 있는 스타트업이 없는 스타트업보다 성과가 좋습니까?몇 달 전, 한 VC 회사는 (거의 확실히 의도하지 않게) 이러한 유형의 편견을 보여주는 연구를 발표했습니다.First Round Capital은 포트폴리오 회사 ​​중 여성 창업자가 있는 스타트업이 없는 스타트업보다 63% 더 나은 성과를 냈다는 사실을 발견했습니다.[2]내가 이 기술이 많은 사람들에게 놀라운 일이 될 것이라고 말하면서 시작한 이유는 이러한 유형의 분석을 거의 볼 수 없기 때문입니다.나는 그들이 한 경기를 펼친 것이 첫 번째 라운드에 놀라운 일이 될 것이라고 확신합니다.표본을 자신의 포트폴리오로 제한함으로써 스타트업 동향이 아니라 회사를 선택할 때 자신의 편견에 대한 연구를 작성하고 있다는 사실을 깨달은 사람이 있을지 의심됩니다. 앞으로 이 기술이 더 많이 사용되는 것을 보게 될 것으로 예상됩니다.그러한 연구를 수행하는 데 필요한 정보는 점점 더 많이 제공되고 있습니다.누가 신청했는지에 대한 데이터는 일반적으로 해당 항목을 선택하는 조직에 의해 엄격하게 보호되지만, 요즘에는 누가 선택되는지에 대한 데이터를 집계하는 데 어려움을 겪는 모든 사람이 공개적으로 사용할 수 있는 경우가 많습니다.참고[1] 선택 과정에서 다양한 유형의 지원자로부터 서로 다른 사항을 찾는 경우에는 이 기술이 작동하지 않습니다. 예를 들어 고용주가 남성은 능력을 기준으로 고용하고 여성은 외모를 기준으로 고용하는 경우입니다.[2]Paul Buchheit가 지적했듯이 First Round는 가장 성공적인 투자인 Uber를 연구에서 제외했습니다.일부 유형의 연구에서는 이상치를 제외하는 것이 합리적이지만, 이상치에 도달하는 것이 전부인 스타트업 투자의 수익에 대한 연구는 그중 하나가 아닙니다.초안을 읽어주신 Sam Altman, Jessica Livingston, Geoff Ralston에게 감사드립니다.아랍어 번역스웨덴어 번역
