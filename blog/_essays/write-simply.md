...
difficulty: 중급
year: 
url_original: "https://paulgraham.com/simply.html"
---
...
2021년 3월
 ...
 나는 평범한 단어와 간단한 문장을 사용하여 글을 쓰려고 노력합니다. 그런 종류의 글은 읽기 쉽고, 읽기 쉬운 글일수록 독자가 더 깊이 관여하게 됩니다.그들이 당신의 산문에 더 적은 에너지를 쏟을수록 당신의 아이디어에 더 많은 시간을 할애할 것입니다. 그리고 더 많이 읽을 것입니다.대부분의 독자의 에너지는 기사나 에세이를 통해 부분적으로 표시되는 경향이 있습니다.독서의 마찰력이 충분히 낮으면 끝까지 계속해서 읽습니다. '입 속으로 뛰어든다'는 뜻의 살팀보카(Saltimbocca)라는 이탈리아 요리가 있습니다.글을 쓸 때 나의 목표는 솔트인테스타(saltintesta)라고 할 수 있습니다. 아이디어가 머리 속에 떠올랐다가 거기에 도달한 단어를 거의 알아차리지 못하는 것입니다. 글쓰기가 순수한 아이디어가 될 수 있기를 바라는 것은 너무 지나친 일입니다.당신은 그것을 원하지 않을 수도 있습니다.하지만 대부분의 작가들에게는 대부분의 경우 그것이 목표로 삼는 목표입니다.대부분의 글쓰기와 순수한 생각 사이의 간격은 시로 채워지지 않습니다. 게다가 단순하게 쓰는 것이 더 배려심이 깊습니다.사람들에게 깊은 인상을 주기 위해 멋진 방법으로 글을 쓴다면, 당신이 멋있어 보이도록 사람들이 추가 작업을 하게 만드는 것입니다.그것은 독자들이 짊어져야 할 긴 기차를 따라가는 것과 같습니다. 그리고 당신이 영어로 글을 쓴다면 많은 독자들이 영어를 모국어로 사용하지 않을 것이라는 점을 기억하십시오.아이디어에 대한 이해가 영어에 대한 이해보다 훨씬 앞서 있을 수 있습니다.그러니 어려운 주제에 대해 글을 쓴다고 해서 어려운 단어를 사용할 수 있다고 단정할 수는 없습니다. 물론 멋진 글이 단지 아이디어를 숨기는 것만은 아닙니다.또한 부족한 부분을 숨길 수도 있습니다.그렇기 때문에 어떤 사람들은 할 말이 없다는 사실을 숨기기 위해 그런 식으로 글을 쓰는 것입니다.글쓰기는 단순히 당신을 정직하게 유지합니다.아무 것도 간단하게 말하지 않으면 당신을 포함한 모든 사람에게 분명해질 것입니다. 간단한 글쓰기도 더 오래갑니다.미래에 당신의 글을 읽는 사람들은 오늘날 다른 나라의 사람들이 그것을 읽는 것과 거의 같은 위치에 있을 것입니다.문화도, 언어도 변할 것이다.목공인이 오래 사용할 수 있는 의자를 만드는 것이 헛된 일이 아니듯이, 그것에 관심을 갖는 것도 헛된 일이 아닙니다. 실제로 오래 지속된다는 것은 단순히 의자의 우연한 품질이나 글쓰기가 아닙니다.그것은 당신이 일을 잘했다는 표시입니다. 그러나 이것들은 모두 단순하게 글쓰기의 실제 장점이지만, 그 중 어느 것도 제가 이 일을 하는 이유는 아닙니다.내가 글을 쓰는 가장 큰 이유는 글을 쓰지 않으면 기분이 상하기 때문이다.너무 복잡해 보이는 문장을 쓰거나, 불필요하게 지적인 단어를 사용하는 문장을 쓰면, 나에게는 화려해 보이지 않습니다.서투른 것 같습니다. 물론 효과를 위해 복잡한 문장이나 화려한 단어를 사용하고 싶을 때도 있습니다.하지만 결코 우연히 그렇게 해서는 안 됩니다. 내 글이 단순해지는 또 다른 이유는 내가 하는 방식 때문입니다.나는 첫 번째 초안을 빠르게 작성한 다음 그것을 편집하는 데 며칠을 소비하며 모든 것이 제대로 되도록 노력합니다.이 편집의 대부분은 잘라내기 작업이므로 간단한 글쓰기가 더욱 간단해집니다.
