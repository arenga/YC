...
difficulty: 중급
year: 
url_original: "https://paulgraham.com/whyyc.html"
---
...
어제 우리가 자금을 지원한 창업자 중 한 명이 Y Combinator를 시작한 이유를 물었습니다. 아니면 좀 더 정확하게는 우리가 주로 재미로 YC를 시작했는지 물었습니다.

일종의 그렇지만, 꼭 그런 것은 아닙니다. Rtm과 Trevor와 다시 작업할 수 있게 되어 정말 재미있습니다. 저는 Viaweb을 매각한 후 그 점을 놓쳤고, 수년 동안 우리가 함께 할 수 있는 일을 찾기 위해 항상 백그라운드 프로세스를 실행했습니다. Y Combinator에는 확실히 밴드 재결합의 측면이 있습니다. 며칠에 한 번씩 저는 그것을 "Viaweb"이라고 부릅니다.

Viaweb은 돈을 벌기 위해 매우 명시적으로 시작했습니다. 저는 하나의 프리랜서 프로젝트에서 다음 프로젝트로 살아가는 것이 지겨워서, 문제를 완전히 해결할 수 있을 만큼 충분히 벌 수 있을 때까지 최선을 다해 일하기로 결정했습니다. Viaweb은 때때로 재미있었지만 재미를 위해 설계되지 않았고, 대부분 재미가 없었습니다. 어떤 스타트업이라도 그럴 것 같습니다. 모든 스타트업은 대부분 고된 일입니다.

우리가 Y Combinator를 시작한 진짜 이유는 이기심도 아니고 덕심도 아닙니다. 우리는 주로 돈을 벌기 위해 이 일을 시작한 것이 아닙니다. 우리는 평균 수익률이 얼마인지 전혀 모르고, 수년 동안 알지 못할 것입니다. 우리는 주로 젊은 창업가 지망생들을 돕기 위해 YC를 시작한 것도 아닙니다. 비록 아이디어가 마음에 들었고, 투자금이 모두 바닥나면 비이기적인 일을 하게 될 것이라는 생각으로 때때로 스스로를 위로하기도 했습니다. (이상하게도 비결정적입니다.)

우리가 Y Combinator를 시작한 진짜 이유는 아마도 해커만이 이해할 수 있는 이유일 것입니다. 정말 대단한 해킹처럼 보였기 때문에 우리는 그렇게 했습니다. 회사를 시작할 수 있는 사람이 있든 없든 수천 명의 똑똑한 사람들이 있으며, 상대적으로 적은 양의 힘을 적절한 곳에 가함으로써 우리는 세상에 존재하지 않았을 새로운 스타트업의 흐름을 탄생시킬 수 있습니다.

어떤 면에서는 이것은 선한 일입니다. 왜냐하면 스타트업은 좋은 것이라고 생각하기 때문입니다. 그러나 실제로 우리에게 동기를 부여하는 것은 복잡한 장치를 살펴보고 작은 조정만으로 장치를 보다 효율적으로 실행할 수 있다는 것을 깨달은 해커에게 동기를 부여하는 완전히 비도덕적인 욕구입니다. 이 경우 장치는 다행스럽게도 오픈 소스인 세계 경제입니다.
