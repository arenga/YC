...
(원래 기업가 정신에 대한 보고서를 작성하는 회사의 요청으로 이 글을 썼습니다. 불행하게도 이 글을 읽은 후에는 포함하기에는 너무 논란의 여지가 있다고 결정했습니다.)

VC 자금 조달은 일반적으로 불경기에 그렇듯이 현재 경기 침체 기간에도 다소 고갈될 것입니다. 하지만 이번에는 결과가 다를 수도 있습니다. 이번에는 신규 스타트업 수가 줄어들지 않을 수도 있습니다. 그리고 그것은 VC들에게 위험할 수 있습니다.

인터넷 버블 이후 VC 자금이 고갈되자 스타트업도 고갈되었습니다. 2003년에는 새로운 스타트업이 많이 설립되지 않았습니다.

그러나 스타트업은 10년 전처럼 VC에 묶여 있지 않습니다. 이제 VC와 스타트업이 갈라지는 것이 가능해졌습니다. 그리고 만약 그렇다면, 경제가 좋아지면 다시 수렴하지 않을 수도 있습니다.스타트업이 더 이상 VC에 그다지 의존하지 않는 이유는 지금까지 스타트업 비즈니스에 종사하는 모든 사람이 알고 있는 것입니다. 스타트업을 시작하는 것이 훨씬 저렴해졌기 때문입니다.

네 가지 주된 이유가 있습니다:

- 무어의 법칙으로 인해 하드웨어가 저렴해졌습니다
- 오픈 소스는 소프트웨어를 무료로 만들었습니다
- 웹은 마케팅과 배포를 무료로 만들었습니다
- 더욱 강력한 프로그래밍 언어는 개발 팀의 규모를 줄일 수 있음을 의미합니다

이러한 변화로 인해 스타트업을 시작하는 데 드는 비용이 소음 속으로 밀려났습니다. 많은 스타트업(아마도 Y Combinator가 자금을 지원하는 대부분의 스타트업)에서 가장 큰 비용은 단순히 창업자의 생활비입니다. 한 달에 3,000달러의 수익을 올리는 스타트업이 있습니다.

수익이 늘어나면 3,000달러는 미미합니다. 왜 한 달에 3000달러를 버는 스타트업에 관심을 가져야 할까요? 비록 수익만큼은 미미하지만 이 금액은 스타트업의 자금 상황을 완전히 바꿀 수 있기 때문입니다.스타트업을 운영하는 사람은 항상 마음 속으로 얼마나 많은 "활주로"를 가지고 있는지, 즉 은행에 있는 돈이 바닥나고 수익을 내거나 더 많은 자금을 조달하거나 사업을 중단해야 할 때까지 얼마나 남았는지 계산하고 있습니다.

아무리 낮더라도 수익성의 한계점을 넘으면 활주로는 무한해집니다. 엔터프라이즈가 워프 속도로 가속할 때 별이 선으로 변하고 사라지는 것과 같은 질적인 변화입니다. 일단 수익성이 생기면 투자자의 돈이 필요하지 않습니다.

그리고 인터넷 스타트업의 운영 비용이 너무 저렴해졌기 때문에 수익성의 한계점도 아주 낮을 수 있습니다. 이는 많은 인터넷 스타트업이 더 이상 VC 규모의 투자가 필요하지 않다는 것을 의미합니다. 많은 스타트업에게 VC 자금 조달은 VC의 언어로 말하면 필수 항목에서 있으면 좋은 항목으로 바뀌었습니다.이러한 변화는 아무도 보지 않는 동안 발생했으며 그 효과는 지금까지 대부분 가려져 있었습니다. 스타트업을 시작하는 것이 사소하게 저렴해진 것은 인터넷 버블 이후 저점에 있었지만, 스타트업이 너무 유행에 뒤떨어져 있었기 때문에 이를 깨닫는 사람은 거의 없었습니다.

2005년경 스타트업이 다시 패션으로 돌아오자 투자자들은 다시 수표를 쓰기 시작했습니다. 그리고 창업자들은 예전처럼 VC 자금이 필요하지 않았을 수도 있지만 제공된다면 기꺼이 받아들였습니다. 부분적으로는 스타트업이 VC 자금을 받는 전통이 있었고, 부분적으로는 개와 같은 스타트업이 기회가 주어지면 먹는 경향이 있기 때문입니다.

VC가 수표를 작성하는 한 창업자는 자신에게 필요한 금액의 한계를 탐색하도록 강요받지 않았습니다. 특이한 상황으로 인해 우연히 이러한 한계에 부딪힌 스타트업이 몇 군데 있었습니다. 가장 유명한 것은 37signals인데, 다른 방향에서 스타트업 영역으로 넘어갔기 때문에 한계에 부딪혔습니다. 그들은 컨설팅 회사로 시작했기 때문에 제품을 만들기 전에 수익을 얻었습니다.

VC와 창업자는 서로 결합되어 있던 두 구성 요소와 같습니다. 2000년경에 볼트가 제거되었습니다. 구성 요소가 지금까지 동일한 힘을 받았기 때문에 여전히 서로 결합되어 있는 것처럼 보이지만 실제로는 하나가 다른 하나 위에 놓여 있을 뿐입니다. 날카로운 충격으로 인해 날아갈 수 있습니다. 그리고 현재의 경기 침체가 그 영향을 미칠 수 있습니다.

스펙트럼의 극단에 있는 Y Combinator의 위치 때문에 우리는 창업자와 투자자 사이의 분리 조짐을 가장 먼저 보게 될 것이며 실제로 그것을 목격하고 있습니다. 예를 들어, 비록 주식 시장 붕괴는 투자자들을 더욱 조심스럽게 만든 것 같지만, 스타트업을 시작하려는 사람들의 수에는 아무런 영향을 미치지 않은 것 같습니다.

우리는 6개월마다 자금 지원 신청을 받습니다. 현재 자금 조달 주기에 대한 신청은 시장이 폭락한 지 한참 후인 10월 17일에 마감되었으며, 그럼에도 불구하고 우리는 1년 전 같은 주기보다 40% 증가한 기록적인 수치를 얻었습니다.

경제가 계속 악화된다면 지금으로부터 1년 후에 상황이 달라질 수도 있지만 지금까지 잠재적 창업자들 사이에 관심이 둔화되는 현상은 전혀 없습니다. 그것은 2001년의 느낌과는 다릅니다. 그러자 잠재적인 창업자들 사이에는 스타트업은 이제 끝났고 그냥 대학원에 가야 한다는 인식이 널리 퍼졌습니다.

이번에는 그런 일이 일어나지 않고, 그 이유 중 하나는 불황 속에서도 한 달에 3000달러를 버는 집을 짓는 것이 그렇게 어렵지 않기 때문입니다. 투자자가 수표 발행을 중단하면 누가 신경쓰나요?우리는 또한 우리가 자금을 지원한 기존 스타트업의 태도에서 창업자와 투자자 사이에 차이가 있다는 조짐을 봅니다. 저는 최근에 투자자들이 우위에 있다고 느낄 때 거래를 깨뜨리는 일종의 사소한 일, 즉 창업자들이 83(b) 양식을 올바르게 제출했는지에 대한 불확실성 때문에 마지막 순간에 라운드가 실패했던 한 사람과 이야기를 나누었습니다.

그럼에도 불구하고 이 스타트업은 분명 성공할 것입니다. 트래픽과 수익 그래프는 제트기가 이륙하는 것처럼 보입니다. 그래서 더 많은 투자자들에게 소개해주기를 원하는지 물었습니다. 놀랍게도 그들은 거절했습니다. 단지 4개월 동안 투자자들과 거래를 했는데 이제는 그럴 필요가 없어져서 실제로 훨씬 더 행복해졌다는 것입니다.

투자자금으로 고용하고 싶은 친구가 있었는데 이제는 그걸 미뤄야 할 것 같습니다. 그러나 그렇지 않으면 그들은 수익성을 낼 만큼 은행에 충분한 여유가 있다고 느꼈습니다. 확실히 하기 위해 그들은 더 저렴한 아파트로 이사하고 있었습니다. 그리고 현 경제 상황에서는 그들이 좋은 거래를 했을 것이라고 확신합니다.

저는 최근에 대화를 나눈 몇몇 YC 창업자들로부터 "투자자들은 문제를 겪을 가치가 없습니다"라는 분위기를 감지했습니다. 가장 최근(여름) 주기의 적어도 하나의 스타트업은 VC는 물론 엔젤 자금도 조달하지 못할 수도 있습니다. Ticketstumbler는 Y Combinator의 15,000달러 투자로 수익성을 얻었으며 더 이상 투자하지 않기를 바랍니다. 이것은 우리조차도 놀랐습니다. YC는 스타트업을 시작하는 것이 저렴하다는 아이디어에 기반을 두고 있지만 창업자가 YC 자금만으로 성공적인 스타트업을 성장시킬 것이라고는 결코 예상하지 못했습니다.

창업자가 VC가 문제를 겪을 가치가 없다고 결정한다면 이는 VC에게 좋지 않을 수 있습니다. 몇 년 후에 경제가 회복되고 다시 수표를 쓸 준비가 되면 창업자가 다른 곳으로 이동했다는 것을 알 수 있습니다.

VC 커뮤니티와 마찬가지로 창업자 커뮤니티도 있습니다. 그들은 모두 서로를 알고 있으며 그들 사이에 기술이 빠르게 퍼졌습니다. 새로운 프로그래밍 언어나 새로운 호스팅 제공업체를 사용해 좋은 결과를 얻으면 6개월 후에 절반이 그것을 사용하게 됩니다. 그리고 자금 조달도 마찬가지입니다.

현재 세대의 창업자들은 VC, 특히 Sequoia로부터 돈을 모으고 싶어합니다. 왜냐하면 Larry와 Sergey가 VC, 특히 Sequoia로부터 돈을 받았기 때문입니다. 차세대 인기 기업이 VC를 전혀 받아들이지 않는다면 VC 비즈니스에 어떤 영향을 미칠지 상상해 보십시오.

VC는 자신들이 제로섬 게임을 하고 있다고 생각합니다. 사실 그것도 아닙니다. Benchmark에 대한 거래를 잃으면 해당 거래를 잃게 되지만 업계로서의 VC는 여전히 승리합니다. None에게 딜을 잃으면 모든 VC가 패하게 됩니다.

이번 불황은 인터넷 버블 이후의 불황과 다를 수 있습니다. 이번에는 창업자가 스타트업을 계속 시작할 수도 있습니다. 만약 그렇게 한다면 VC는 계속해서 수표를 작성해야 할 것입니다. 그렇지 않으면 관련성이 없어질 수 있습니다.

**감사의 말**

초안을 읽어주신 Sam Altman, Trevor Blackwell, David Hornik, Jessica Livingston, Robert Morris 및 Fred Wilson에게 감사드립니다.
