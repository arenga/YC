...
difficulty: 중급
year: 
url_original: "https://paulgraham.com/hiresfund.html"
---
...
스타트업이 엔젤 라운드에서 전환사채를 더 많이 사용하는 이유는 거래가 더 빨리 성사되기 때문입니다. 스타트업이 다양한 투자자에게 서로 다른 가격을 더 쉽게 제공할 수 있게 함으로써 투자자가 모두 누가 투자할 것인지 기다릴 때 발생하는 일종의 교착 상태를 깨는 데 도움이 됩니다.

지금까지 스타트업에 대한 투자자의 의견에 가장 큰 영향을 미치는 것은 다른 투자자의 의견입니다. 스스로 결정하는 사람은 거의 없습니다. 모든 스타트업 창업자는 투자자로부터 듣는 가장 일반적인 질문이 창업자나 제품에 관한 것이 아니라 "다른 누가 투자하고 있습니까?"라고 말할 수 있습니다.

이는 교착 상태를 일으키는 경향이 있습니다. 구식 고정 규모 주식 라운드를 올리는 데는 몇 주가 걸릴 수 있습니다. 왜냐하면 모든 엔젤들이 다른 사람들이 투자하기를 기다리기 때문입니다. 마치 자전거 경주를 하는 경쟁자들이 처음에 먼저 깨는 사람을 따라갈 수 있도록 의도적으로 천천히 타는 경쟁자들처럼 말입니다.컨버터블 노트를 사용하면 스타트업은 기꺼이 낮은(유효한) 가치 평가로 먼저 움직이려는 투자자들에게 보상함으로써 이러한 교착 상태를 극복할 수 있습니다. 그들은 더 많은 위험을 감수하고 있기 때문에 그럴 자격이 있습니다. Ron Conway가 이미 투자한 스타트업에 투자하는 것이 훨씬 더 안전합니다. 그 뒤를 잇는 사람은 더 높은 가격을 지불해야 합니다.

전환사채가 가격에 더 많은 유연성을 허용하는 이유는 평가 상한액이 실제 평가가 아니며, 노트가 저렴하고 하기 쉽기 때문입니다. 따라서 고해상도의 자금 조달을 할 수 있습니다. 원할 경우 각 투자자에 대해 서로 다른 한도가 있는 별도의 노트를 가질 수 있습니다.

해당 한도는 단순히 단조롭게 증가할 필요가 없습니다. 스타트업은 또한 자신에게 가장 도움이 될 것이라고 기대하는 투자자에게 더 나은 거래를 제공할 수도 있습니다. 요점은 단순히 다양한 투자자가 제공하는 도움이나 헌신하려는 의지로 인해 스타트업에 대해 서로 다른 가치를 갖고 있으며 조건이 이를 반영해야 한다는 것입니다.

투자자마다 다른 조건은 분명히 미래의 방식입니다. 시장은 항상 더 높은 해상도를 향해 진화합니다. 이를 위해 컨버터블 노트를 사용할 필요가 없을 수도 있습니다. 충분히 가벼운 표준화된 주식 조건(및 주식 라운드에 대한 투자자 및 변호사의 기대에 대한 일부 변경)을 사용하면 부채 대신 주식으로 동일한 작업을 수행할 수 있습니다. 가치 평가를 쉽게 변경할 수 있는 한 스타트업에서는 어느 쪽이든 괜찮습니다.고정 규모 주식 라운드의 유일한 문제는 교착 상태가 아니었습니다. 또 다른 점은 스타트업이 얼마를 조달할지 미리 결정해야 한다는 점이었습니다. 저는 스타트업이 특정 수치를 정하는 것은 실수라고 생각합니다. 투자자가 쉽게 확신한다면 스타트업은 지금 더 많은 자금을 조달해야 하고, 투자자가 회의적이라면 스타트업은 더 적은 금액을 사용하여 회사가 더 설득력 있는 지점에 도달하도록 해야 합니다.

스타트업이 최적의 라운드 크기를 미리 선택하는 것은 투자자의 반응에 따라 달라지고 예측이 불가능하기 때문에 합리적이지 않습니다. 한 가지 가능성은 이 관습이 투자자들이 공모를 피할 수 있을 때 공모하는 방식을 반영한다는 것입니다. 하지만 실제 설명은 덜 불길하다고 생각합니다.

저는 엔젤들(그리고 그들의 변호사들)이 VC 시리즈 A 라운드를 무심코 모방하여 이런 식으로 라운드를 조직했다고 생각합니다. 시리즈 A에서는 선두가 있는 고정 규모 주식 라운드가 합리적입니다. 왜냐하면 일반적으로 명백히 선두인 대규모 투자자가 단 한 명 있기 때문입니다. 고정 크기 시리즈 A 라운드는 이미 고해상도입니다. 그러나 한 라운드에 더 많은 투자자가 있을수록 모든 사람이 동일한 가격을 받는 것은 의미가 없습니다.

여기서 가장 흥미로운 질문은 고해상도 자금 조달이 투자자 세계에 어떤 영향을 미칠지일 것입니다. 이제 더 대담한 투자자들은 더 낮은 가격으로 보상을 받을 것입니다. 그러나 히트 중심 비즈니스에서 더 중요한 것은 그들이 원하는 거래를 성사시킬 수 있다는 것입니다. 반면에 "또 누가 투자하고 있나요?"유형의 투자자는 더 높은 가격을 지불할 뿐만 아니라 투자할 능력이 없을 수도 있습니다.
