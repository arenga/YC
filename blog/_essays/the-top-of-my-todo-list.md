...
difficulty: 중급
year: 
url_original: "https://paulgraham.com/todo.html"
---

## 요약 (Summary)

🎯 당신의 할일 목록 맨 위에는 무엇이 있나요?
...
2012년 4월 Bronnie Ware라는 완화의료 간호사가 임종자의 가장 큰 후회 목록을 작성했습니다.그녀의 목록은 그럴듯해 보인다.나는 내 자신을 볼 수 있었습니다 – 나 자신을 볼 수 있었습니다 – 이 5가지 실수 중 적어도 4번을 하고 있습니다. 그것들을 하나의 조언으로 압축해야 한다면 다음과 같을 것입니다: 톱니바퀴가 되지 마십시오.5가지 후회는 상황에 맞게 자신을 축소했다가 멈출 때까지 충실하게 변하는 후기산업인의 초상을 그린다. 놀라운 것은 이러한 후회를 낳는 실수는 모두 생략의 오류라는 것이다.꿈을 잊고, 가족을 무시하고, 감정을 억누르고, 친구를 무시하고, 행복해지는 것을 잊어버립니다.누락 오류는 기본적으로 발생하기 때문에 특히 위험한 유형의 실수입니다. 이러한 실수를 피하고 싶습니다.하지만 기본적으로 저지르는 실수를 어떻게 방지할 수 있나요?이상적으로는 인생을 변화시켜 다른 기본값을 갖게 됩니다.그러나 완전히 그렇게 하는 것은 불가능할 수도 있습니다.이러한 실수가 기본적으로 발생하는 한 이러한 실수를 하지 않도록 상기시켜 주어야 할 것입니다.그래서 저는 5가지 후회를 뒤집어서 5가지 명령 목록을 만들었습니다. 꿈을 무시하지 마세요.너무 많이 일하지 마세요.당신의 생각을 말하십시오;우정을 쌓으세요.행복해요.그런 다음 할 일 목록으로 사용하는 파일 상단에 넣습니다.일본어 번역
