...
**난이도**: 중급
**출판일**: N/A
**원문**: https://paulgraham.com/foundervisa.html
---
## 요약 (Summary)
...
2009년 4월저는 평소 정치를 기피하지만 지금은 제안을 받아들이는 정부가 있는 것 같아서 위험을 무릅쓰고 정치를 만들겠습니다.이 나라에서 스타트업 수를 늘리기 위해 정부가 할 수 있는 가장 큰 일은 비용이 전혀 들지 않는 정책입니다. 즉, 스타트업 창업자를 위한 새로운 등급의 비자를 발급하는 것입니다. 미국에서 창업되는 신규 스타트업 수에 대한 가장 큰 제약은 세금 정책이나 고용법, 심지어 Sarbanes-Oxley가 아닙니다.창업하려는 사람들을 국내에 들여보내지 않겠다는 것이다. 매년 스타트업 창업자 1만 명만 국내에 들여보내도 눈에 띄는 경제 효과를 가져올 수 있다.스타트업 당 4명을 가정한다면(아마도 과대평가된 것 같습니다), 이는 2,500개의 새로운 회사가 되는 것입니다.매년.모두 Google만큼 크게 성장하지는 않지만 2,500명 중 일부는 이에 근접할 것입니다. 정의에 따르면 이 10,000명의 창업자는 미국인에게서 일자리를 빼앗지 않을 것입니다. 이는 그들이 기존 회사에서 일할 수 없고 자신이 설립한 새로운 회사에서만 일할 수 없다는 것이 비자 조건의 일부일 수 있습니다.실제로 그들은 미국인들에게 더 많은 일자리를 제공할 것입니다. 왜냐하면 그들이 시작한 회사는 그들이 성장함에 따라 더 많은 직원을 고용하기 때문입니다. 까다로운 부분은 스타트업을 어떻게 정의하는가인 것처럼 보일 수 있습니다.하지만 이 문제는 아주 쉽게 해결될 수 있습니다. 시장이 결정하게 하세요.스타트업 투자자들은 최고의 스타트업을 찾기 위해 열심히 노력합니다.정부는 이들의 전문성을 업고 인정받은 스타트업 투자자의 투자를 회사가 진짜 스타트업인지 테스트하는 기준으로 활용하는 것보다 더 나은 방법은 없습니다. 정부는 스타트업 투자자가 누구인지 어떻게 결정할까요?같은 방식으로 학생 비자를 위한 대학이 무엇인지 결정합니다.우리는 우리 자신의 인증 절차를 확립할 것입니다.우리는 서로가 누구인지 알고 있습니다. 이민 기준으로는 10,000명에 불과하지만 스타트업 창업자 풀의 엄청난 증가를 의미합니다.이 법안을 발의한 의원을 유명하게 만들 만큼 경제에 가시적인 영향을 미칠 것이라고 생각합니다.확실하게 알 수 있는 유일한 방법은 시도해 보는 것인데, 실제로 비용이 전혀 들지 않습니다.이 초안을 읽어주신 Trevor Blackwell, Paul Buchheit, Jeff Clavier, David Hornik, Jessica Livingston, Greg Mcadoo, Aydin Senkut 및 Fred Wilson에게 감사드립니다. 관련: 미국 기업가들, VC 지원 회사 설립자의 절반 정도가 이민자입니다.
