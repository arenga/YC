...
**난이도**: 중급
**출판일**: N/A
**원문**: https://paulgraham.com/sun.html
---
## 요약 (Summary)
...
2017년 9월가장 귀중한 통찰력은 일반적이면서도 놀라운 통찰력입니다.예를 들어 F = ma입니다.그러나 일반적이고 놀라운 것은 달성하기 어려운 조합입니다.그 영역은 깨끗하게 선택되는 경향이 있는데, 바로 그러한 통찰이 매우 귀중하기 때문입니다. 일반적으로 사람들이 할 수 있는 최선의 방법은 다른 것이 없는 것입니다. 즉, 일반적이지 않으면서 놀랍거나(예: 가십), 놀랍지 않으면서도 일반적입니다(예: 진부한 이야기). 상황이 흥미로워지는 곳은 적당히 가치 있는 통찰입니다.누락된 품질을 약간 추가하여 얻을 수 있습니다.더 일반적인 경우는 일반성을 조금 더한 것입니다. 즉, 단순한 가십 이상의 의미를 지닌 가십입니다. 세상에 대한 흥미로운 사실을 가르쳐주기 때문입니다.그러나 또 다른 덜 일반적인 접근 방식은 가장 일반적인 아이디어에 초점을 맞추고 그에 대해 말할 새로운 내용을 찾을 수 있는지 확인하는 것입니다.이러한 것들은 매우 일반적으로 시작되기 때문에 유용한 통찰력을 얻기 위해서는 약간의 참신함만 필요합니다. 작은 참신함만이 대부분의 시간에 얻을 수 있는 전부입니다.즉, 이 경로를 택하면 아이디어가 이미 존재하는 아이디어와 매우 비슷해 보일 것입니다.때때로 당신은 이미 존재했던 아이디어를 단지 재발견했을 뿐이라는 것을 알게 될 것입니다.그러나 낙심하지 마십시오.조금이라도 새로운 것을 생각해낼 때 발생하는 엄청난 승수를 기억하십시오. 결과: 당신이 말하는 아이디어가 더 일반적일수록 반복하는 것에 대해 걱정할 필요가 줄어듭니다.충분히 쓰면 필연적으로 그렇게 될 것입니다.당신의 두뇌는 해마다 거의 동일하며 두뇌에 영향을 미치는 자극도 마찬가지입니다.제가 예전에 했던 말과 비슷한 말을 마치 제 자신을 표절하는 것처럼 했다는 사실을 알게 되었을 때, 마음이 조금 안타깝습니다.그러나 합리적으로 그렇게 해서는 안 됩니다.두 번째에는 정확히 같은 방식으로 말하지 않을 것이며, 그러한 변화는 작지만 중요한 참신함의 델타를 얻을 가능성을 높입니다. 그리고 물론 아이디어는 아이디어를 낳습니다.(익숙하게 들리네요.) 약간의 참신함이 있는 아이디어는 더 많은 참신함으로 이어질 수 있습니다.하지만 계속 진행하는 경우에만 가능합니다.그러므로 당신이 발견한 것에 대해 별로 새로운 것이 없다고 말하는 사람들 때문에 낙담하지 않는 것이 두 배로 중요합니다."별로 새롭지 않다"는 것은 가장 일반적인 아이디어에 대해 말할 때 진정한 성과입니다.해 아래 새로운 것이 없다는 말은 사실이 아니다.새로운 것이 거의 없는 일부 도메인이 있습니다.그러나 태양 아래 면적을 곱하면 아무것도 없는 것과 거의 없는 것 사이에는 큰 차이가 있습니다.초안을 읽어주신 Sam Altman, Patrick Collison, Jessica Livingston에게 감사드립니다.일본어 번역
